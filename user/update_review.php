<?php
   ...
   if(isset($_POST['submit'])){
      ...
      $update_review = $connForPosts->prepare("UPDATE `rating_reviews` SET rating = ?, title = ?, description = ? WHERE id = ?");
...
<section class="account-form">
   ...
   <?php
      $select_review = $connForPosts->prepare("SELECT * FROM `rating_reviews` WHERE id = ? LIMIT 1");
